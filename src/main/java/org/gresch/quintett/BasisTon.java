...
public class BasisTon {
  ...
  public static boolean istGueltigerBasisTonName(String xTonName) {
    ...
    if (StringUtils.isEmpty(xTonName)) {
      ...
      istGueltig = (Name.C.equals(xTonName) || xTonName.equals(Name.D) || xTonName.equals(Name.E) || xTonName.equals(Name.F) || xTonName.equals(Name.G)
        || xTonName.equals(Name.A) || xTonName.equals(Name.H));
    }
