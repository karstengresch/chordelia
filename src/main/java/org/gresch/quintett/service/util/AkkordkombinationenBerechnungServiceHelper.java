  ...
  public static int getKlangschaerfe(List<Ton> xTonList, AesthetischeGewichtung xAesthetischeGewichtung)
  {
    ...
    for (i = 0; i < xTonList.size(); i++)
    {
      ...
      else
      {
        ...
        klangschaerfe += xAesthetischeGewichtung.getKlangschaerfe(tonList.get(i).getAbstandZumEingestrichenenC() - tonList.get(i - 1).getAbstandZumEingestrichenenC());
        if (log.isDebugEnabled())
        {
          log.debug("Akkord.Akkord(): Klangschärfe für Abstand " + (tonList.get(i).getAbstandZumEingestrichenenC() - tonList.get(i - 1).getAbstandZumEingestrichenenC()) + " | Hinzugefügt: "
              + xAesthetischeGewichtung.getKlangschaerfe(tonList.get(i).getAbstandZumEingestrichenenC() - tonList.get(i - 1).getAbstandZumEingestrichenenC()));
