...
public class ThreadLocalUtil {
  ...
  public static void cleanupThreadLocals(Thread thread, final String classFilter, final ClassLoader classLoader) {
    if (classLoader != null) {
      System.out
        .println("@@ cleanupThreadLocals for classLoader=" + classLoader.getClass().getName() + "@" + Integer.toHexString(classLoader.hashCode()));
    }
                ...
                if (entryList[iEntry] != null) {
                  ...
                  if (fValue != null) {
                    ...
                    if (value != null) {
                      boolean flag = true;
                      System.out
                        .println("found entry: value=" + value.getClass().getName() + "@" + Integer.toHexString(value.hashCode()));
                      ...
                      if (flag) {
                        System.out.println("@@ Entry for " + value.getClass().getName() + "@" + Integer.toHexString(value.hashCode())
                          + " cleared.");
