...
public abstract class Name {
  ...
  public static String getVollstaendigerTonName(Oktavlage xOktavlage, String xTonName)
  {
    ...
    {
      _logger.error("Name.getVollstaendigerTonName(): Kann keinen vollständigen Tonnamen bilden für folgende Argumente: Oktavlage:'" + xOktavlage + "' - Tonname: '" + xTonName + "'!");
    }
...
// TODO Subclassing für LiliypondName!
  ...
  public static String getLilyPondTonName(Oktavlage xOktavlage, String xTonName)
  {
    ...
    else
    {
      ...
      _logger.error("Name.getVollstaendigerTonName(): Kann keinen vollständigen Lilypond-Tonnamen bilden für folgende Argumente: Oktavlage:'" + xOktavlage + "' - Tonname: '" + xTonName + "'!");
    }
